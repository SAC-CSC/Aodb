...
@Setter
@Service
public class Plc02Service {

    @Value("${plc02.ipAddress}")
    private String ipAddress;

    @Value("${plc02.port}")
    private int port;

    @Value("${plc02.telegram-read-time-out}")
    private int readTimeout;

    @Value("${plc02.ping-interval:10000}")
    private int pingInterval;

    @Value("${plc02.sql-status-check-interval:10000}")
    private int sqlStatusCheckInterval;

    @Value("${plc02.service-name:CSC_SAC_Service}")  // Add your service name here
